...
```
Результат можно наблюдать на R22. Теперь маршрут в Москву через R14 удлинился и стал невыгодным. Для входящего трафика в AS1001 (100.1.0.0/16) он больше не выбирается, если только это жестко не указано.
```
R22#sh ip bgp
