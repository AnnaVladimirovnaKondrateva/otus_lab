...
Настроила RR на R23. R26 R25 являются клиентами RR. Такое решение повысит отказоустройчивость сети провайдера Триада. Сначала настроила eBGP соседство между RR23 RR22
```
